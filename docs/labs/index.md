...
!!! note "Это курсовые задания, а не DSA-лабы из репозитория"
    На этой странице — **учебные лабораторные работы курса**: задания по темам лекций, которые студент выполняет в отдельном репозитории. Их не путать с **DSA-лабами** `lab00`–`lab11` (массив, стек, сортировки, графы, hash map и т.д.) — те реализованы прямо в этом репозитории, их код и разбор сложности см. в [конспекте DSA](../notes.md).
...
## Тема 1. [Основные принципы алгоритмизации](../foundations/01-algorithm-basics/index.md)
...
## Тема 3. [Программирование на Python](../foundations/03-python-basics/index.md)
...
## Тема 4. [Подпрограммы и работа с файлами](../foundations/04-procedures-and-files/index.md)
...
## Тема 11. [Разработка приложений](../ops/11-application-development/index.md)
...
3. Все Python-проекты — на `uv` (см. [тему 5](../foundations/05-libraries-and-modules/lecture-01-modules-packages.md)); Go-проекты — на `go mod` (см. [тему 13](../go/13-golang-basics/lecture-01-intro.md)).
